#ifndef __AUNTEC_BASE_CONFIG_H
#define __AUNTEC_BASE_CONFIG_H
...
// 通过定义AUNTEC_ARCH_DETECTED可以避免auntec_base_conf.h对平台进行检测
#ifndef AUNTEC_ARCH_DETECTED
#define AUNTEC_ARCH_DETECTED
