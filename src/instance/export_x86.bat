...
xcopy /y /s .\..\..\dependency\ui_sdk\win-x86-msvc\bin\*.dll %output_path%

xcopy /y /s .\..\..\dependency\billfish_sdk\sdk\win-x86-msvc\bin\*.*  %output_path%
xcopy /y /s .\..\..\dependency\sqlite3_r\win-x86-msvc\bin\*.dll %output_path%
del /s /q %output_path%\ffmpeg32.exe
del /s /q %output_path%\libMediaCam32.dll
xcopy /y /s .\..\..\dependency\base_platform_sdk\win-x86-msvc\bin\*.dll %output_path%
xcopy /y /s .\..\..\dependency\base_platform_sdk\win-x86-msvc\bin\*.exe %output_path%
copy /y .\..\..\dependency\7z_r\win-x86-msvc\bin\7za.exe %output_path%

copy /y .\..\..\resource\config\qt.conf %output_path%
@REM \mediainfo_r
xcopy /y /s .\..\..\dependency\mediainfo_r\win-x86-msvc\bin\*.dll %output_path%
...
call "%vc_install%Auxiliary\Build\vcvars32.bat"
