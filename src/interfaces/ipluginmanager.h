...
public:
    ...
    virtual QString themePath() const = 0;
    virtual QString translationsPath() const = 0;
    virtual QString datasPath() const = 0;
    virtual QString commonResourcesPath() const = 0;
...
#ifdef Q_OS_MAC
    virtual void dockIconClicked() = 0;
#endif
};

#define IPlugin_iid "JIM.Core.IPlugin/1.0"
Q_DECLARE_INTERFACE(IPlugin,IPlugin_iid)
#define IPluginManager_iid  "JIM.Core.IPluginManager/1.1"
Q_DECLARE_INTERFACE(IPluginManager,IPluginManager_iid)
