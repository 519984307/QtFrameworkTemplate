...
#ifndef Q_OS_MAC
QxtGlobalShortcutEventFilter* QxtGlobalShortcutPrivate::prevEventFilter = 0;
QxtGlobalShortcutEventFilter* QxtGlobalShortcutPrivate::eventFilter = new QxtGlobalShortcutEventFilter();
#endif
...
#ifndef Q_OS_MAC
    if (!--ref)
        QAbstractEventDispatcher::instance()->installNativeEventFilter(prevEventFilter);
#endif
}
...
bool QxtGlobalShortcut::setShortcut(const QKeySequence& shortcut)
{
    ...
    if(shortcut.isEmpty()){
        qInfo() << "QxtGlobalShortcut::setShortcut empty";
        return false;
    }
