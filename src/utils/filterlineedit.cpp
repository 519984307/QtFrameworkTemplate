...
void FilterLineEdit::setThemePath(const QString &path)
{
    m_themePath = path;
    QIcon icon = QIcon::fromTheme(layoutDirection() == Qt::LeftToRight ?
                     QLatin1String("edit-clear-locationbar-rtl") :
                     QLatin1String("edit-clear-locationbar-ltr"),
                     QIcon::fromTheme(QLatin1String("edit-clear"), QIcon(QLatin1String(m_themePath.toLatin1() + "/images/editclear.png"))));
